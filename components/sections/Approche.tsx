...
/**
 * Section Approche — PHR-ARCHITECTURE § #approche.
 * Trois principes, style sobre document. Phrase de clôture italique sage.
 * Fond sable, filets, aucun bordeaux (budget page).
 */
...
const PRINCIPES = [
  {
    ...
    texte:
      "Nous privilégions les solutions claires, sans complexité inutile. Ce qui est simple tient dans le temps.",
  },
  {
    num: "02",
    titre: "Souple et léger",
    texte:
      "Des structures adaptées à votre réalité, jamais surdimensionnées. Vous gardez l'agilité.",
  },
  {
    num: "03",
    titre: "Toujours la meilleure option",
    texte:
      "Nous cherchons en continu la solution la plus juste pour vous. C'est notre manière de travailler depuis quarante ans.",
  },
];
    ...
    <section id="approche" className="border-t border-line">
      <div className="mx-auto max-w-content px-7 py-16 md:px-14 md:py-20">
        ...
        <div className="flex flex-col gap-12 md:flex-row md:gap-20">
          ...
          {/* Colonne droite — trois principes en filets */}
          <div className="flex-1 border-t border-line">
            {PRINCIPES.map((p, i) => (
              ...
              >
                <span className="shrink-0 font-display text-[13px] italic text-sage">
                  {p.num}
                </span>
                <div>
